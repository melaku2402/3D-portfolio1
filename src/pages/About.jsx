          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-stretch min-h-[600px]">
            ...
            <div className="flex-1 w-full flex justify-center items-center">
              ...
              >
                ...
                {/* Floating Social Elements - Smaller */}
                {/* <div
                  className={`absolute -top-2 -right-2 w-8 h-8   bg-[#915EFF] rounded-full flex items-center justify-center text-white shadow-lg transition-all duration-300 ${
                    imageHovered ? "scale-110 bg-[#7d4dff]" : ""
                  }`}
                  style={{
                    transform:
                ...
                >
                  <SiGraphql size={14} className=" text-[#E10098]" />
                </div> */}

                {/* <div
                  className={`absolute -bottom-2 -left-2 w-8 h-8 bg-[#915EFF] rounded-full flex items-center justify-center text-white shadow-lg transition-all duration-300 ${
                    imageHovered ? "scale-110 bg-[#7d4dff]" : ""
                  }`}
                  style={{
                    transform:
                      floatAnimations[1]?.transform || "translateY(0px)",
                  }}
                >
                  <SiMongodb size={14} />
                </div> */}
