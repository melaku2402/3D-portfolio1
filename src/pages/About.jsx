          ...
          <div className="flex-1 w-full flex flex-col justify-center">
            ...
            >
              ...
              >
                {/* Content Section */}
                <div>
                  <h2 className="text-2xl md:text-3xl font-bold text-[#C3BFFB] mb-4 md:mb-5 text-center">
                    Who Am I!
                  </h2>
                  ...
                  <div className="space-y-3 md:space-y-4 text-[#C3BFFB] text-base md:text-[15px] leading-7 md:leading-8 text-justify">
                    <p>
                      ...
                      responsive, user-centric applications while ensuring
                      robust server-side architecture, database design, and
          ...
          <div className="flex-1 w-full flex justify-center items-center">
            ...
            >
              ...
              >
                ...
                <div className="hidden w-full h-64 md:h-80 bg-[#2d3748] rounded-xl flex items-center justify-center text-white text-sm">
                  <div className="text-center">
                    <div className="text-4xl mb-2">👨‍💻</div>
                    <p>Programmer Image</p>
              ...
              <div
                ...
                style={{
                  transform: floatAnimations[0]?.transform || "translateY(0px)",
                }}
              >
                JS
              </div>
